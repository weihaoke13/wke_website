...
const data = [ 
    {
        avatar: AVTR1,
        name: 'Tina Snow',
        review: " Lorem ipsum dolor sit amet consectetur adipisicing elit Ducimus nihil dolorem quia eveniet. Iste quasi maxime facilis ",
